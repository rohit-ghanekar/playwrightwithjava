package com.expleo.playwrightdemoapp.Factory;
...
public class PlaywrightFactory {
    ...
    public Page initBrowser(Properties prop) {
        ...
        switch (browserName.toLowerCase()) {
            case "chromium":
                tlBrowser.set(getPlaywright().chromium().launch(new BrowserType.LaunchOptions().setHeadless(false).setTimeout(12000)));
                break;
            case "firefox":
        ...
        getPage().setDefaultTimeout(120000);
        return getPage();
